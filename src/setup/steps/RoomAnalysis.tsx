...
import { DETECTED_ZONES } from '../../data/mocks'
...
export function RoomAnalysis({ room, onChangeRoom }: RoomAnalysisProps) {
  return (
    <div className="room-analysis">
      ...
      <div className="room-analysis__zones">
        <p className="room-analysis__zones-label">
          ...
          We found {DETECTED_ZONES.length} placement zones in your room
        </p>
        <div className="zone-chips">
          {DETECTED_ZONES.map(zone => (
